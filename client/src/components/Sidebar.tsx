...
export const Sidebar = () => {
	...
	return (
		<article className="w-full h-12 bg-secondary fixed left-0 bottom-0 flex  items-center justify-around sm:w-50 sm:h-full sm:bg-secondary sm:top-15 sm:flex-col sm:items-start sm:justify-start sm:gap-4 sm:pt-2">
